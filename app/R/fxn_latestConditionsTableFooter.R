...
fxn_latestConditionsTableFooter <- function() {
  latestConditionsTableFooter <- 
    htmltools::p(
      htmltools::HTML(
        "<sup>1</sup> Measurements taken 12 inches above ground&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<sup>2</sup> Values highlighted in red when at or below 32.0 °F&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<sup>3</sup> Values highlighted in red when at or above air temperature
