        ...
        plotly::layout(
          annotations = 
            list(
              list( # Wet
                align = "left",
                font = list(color = "#378dbd", family = layoutFontFamily, size = layoutFontSize),
                showarrow = FALSE,
                text = "Wet",
                x = 0,
                xanchor = "left",
              ...
              list( # Transition
                align = "left",
                font = list(color = "#81d3eb", family = layoutFontFamily, size = layoutFontSize),
                showarrow = FALSE,
                text = "Transition",
                x = 0,
                xanchor = "left",
              ...
              list( # Dry
                align = "left",
                font = list(color = "#989898", family = layoutFontFamily, size = layoutFontSize),
                showarrow = FALSE,
                text = "Dry",
                x = 0,
                xanchor = "left",
